...
// NOTE: audit logging is handled separately by breakglass_log.php,
// which the emergency page JS calls after this lookup succeeds.
// Do NOT audit here — it would produce a duplicate log entry.
